...
fn compute_area(s: &dyn Shape) -> f64 {
...
```
[Run in Rust Playground](https://play.rust-lang.org/?version=stable&mode=debug&edition=2021&gist=8114210e1f28498a0529376711179cba&version=stable)
