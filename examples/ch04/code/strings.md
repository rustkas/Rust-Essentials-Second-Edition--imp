...
fn main() {
    ...
    // println!("{}", magician1[1]);
    println!("\n\r{:?}", magician1.chars().nth(1)); // Some('e')
...
```
[Run in Rust Playground](https://play.rust-lang.org/?version=stable&mode=debug&edition=2021&gist=1c0eba6a00f2756dc9e28e11a6cb7946&version=stable)
