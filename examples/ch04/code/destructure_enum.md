...
fn foo2(x: &En) {
    match x {
        ...
        _ => println!("other (Var4)"), // cannot move out of borrowed content:
                                       // &Var4(_, v, _) => {
...
```
[Run in Rust Playground](https://play.rust-lang.org/?version=stable&mode=debug&edition=2021&gist=4aee4cbbe608207e417d59f0ddef3412&version=stable)
